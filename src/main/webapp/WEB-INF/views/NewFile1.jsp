...
<link rel="stylesheet" href="<%=application.getContextPath()%>/resources/css/mega.css" />
...
<header>
   <div id="navigation">
      <div id="nav-box">
         <div id="logo" style='background: url("resources/img/logo_new.png") no-repeat 0px 0px;'></div>
         <div id="nav-menu" >
            <ul >
               <li>영화</li> 
               <li>큐레이션</li> 
...
<div id="content">
  	<img class="mySlides" src="resources/img/sl1.jpg" style="position: absolute;">
	<img class="mySlides" src="resources/img/sl2.jpg" style="position: absolute;">
	<img class="mySlides" src="resources/img/sl3.jpg" style="position: absolute;">
   <div id="main-top">
	...
	<p><br/><br/><br/><br/>
		<div style="overflow: hidden;width: 100%; display: block; position: relative;">
			<div class="parallax_txt" style="position: absolute; left: 50%; top: 50%;">
				<img style="margin-top: -185px; margin-left: -432.5px;" alt="" src="resources/img/grand_opening.png">
			</div>
			<div id="grand1" class="content_middle_banner parallax_img" style='background: url("resources/img/back_grand.jpg") no-repeat 0px -295.4px / cover; overflow: visible; background-position-x:0px;background-color:black ' data-stellar-background-ratio="0.3">
		...
		<div id="container" style="width: 65%; margin: 0 auto;">
			...
			<div class="part_eve" style="position: relative; width: 975px;">
				...
				<div class="part_eve_left" style="width: 632px; height: 632px; border: 1px solid #cccccc">
					...
					<div style='background: url("resources/img/part1.jpg") no-repeat 0px 0px; float: left; width: 315px; height: 315px;'>
					</div>

					<div style='background: url("resources/img/part2.jpg") no-repeat 0px 0px;float: left; width:315px; height: 315px;'>
					</div>

					<div style='background: url("resources/img/part3.jpg") no-repeat 0px 0px;float: left; width: 315px; height: 315px;'>
					</div>

					<div style='background: url("resources/img/part4.jpg") no-repeat 0px 0px;float: left; width: 315px; height: 315px;'>
					</div>
				...
				<div class="part_eve_right" style="position: absolute; top: 0px; right: 0px; height: 632px;">
					<div>
						<iframe width="330" height="630" src="resources/img/part5.png" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" topmargin="0" leftmargin="0"></iframe>
					</div>
				</div>
			</div>
