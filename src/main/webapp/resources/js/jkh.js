	            ...
	            +' <div tabindex="0" class="modal fade booking_lp in" id="reservation"'
	              ...
	              +' <div class="wrapper">'
	                +' <div tabindex="0" class="contents clearfix ReservationBn_ok">'
	                  ...
	                  +' </script>'
	                  +' <!-- //콘텐츠 -->'
	                  +' <button class="custom_close focus_modal_close" aria-hidden="true"'
	                    +' onclick="Booking.close()" type="button" data-dismiss="modal">'
              ...
              +' <div tabindex="0" class="contents">'
                ...
                +' <div class="seat_body">'
                  +' <div class="left_wrap">'
                    ...
                    +' <!-- 티켓종류선택 -->'
                    +' <div class="row3">'
                      +' <button class="alert_seat" style="display: none;"'
                        +' onclick="$(this).fadeOut();" type="button">'
                  ...
                  +' </div>'
                +' </div>'
                +' <button class="custom_close" data-dismiss="modal" type="button">'
                  +' <span class="blind">창닫기</span>'
                +' </button>'
              +' </div>'
              +' <!-- /.modal-content -->'
