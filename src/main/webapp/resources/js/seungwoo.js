...
seungwoo.movieSubmenu=(()=>{
	...
	var onCreate=()=>{
		...
		$('<a/>',{class:"movie sm02"})
			.text('최신개봉작')
			.appendTo($(".clearfix li").eq(1))
			.click(e=>{
				alert('최신개봉작');
			});
		$('<a/>',{class:"movie sm03"})
			.text('상영예정작')
			.appendTo($(".clearfix li").eq(2))
			.click(e=>{
				alert('상영예정작');
			});
		$('<a/>',{class:"movie sm11"})
			.text('보고싶어')
			.appendTo($(".clearfix li").eq(3))
			.click(e=>{
				alert('보고싶어');
	...
	var setContentView=()=>{
		...
		$(".clearfix").append($('<li/>')).append($('<li/>')).append($('<li/>')).append($('<li/>')).append($('<li/>',{class:"pull-right pt10"}));
	};
	return {init:init};
})();
