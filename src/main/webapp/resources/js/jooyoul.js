...
joo.mega=(()=>{
	...
	var loginbox =()=>{
		...
		$.getScript(temp,()=>{
			alert('loginbox : ');
			$container.html(compUI.loginbox());
			$('#top_logo a').click(e=>{
				alert('메인');
			});
	...
	var membertext =x=>{
		...
		$.getScript(temp,()=>{
			alert('membertext UI: ');
			$container.html(compUI.membertext());
			$("#").click(()=>{
				alert('취소');
				joo.mega.mainbar();
			});
	...
	var memberadd =x=>{
		...
		$.getScript(temp,()=>{
			alert('memberadd UI: ');
			$container.html(compUI.memberadd());
	...
	var nonmember =x=>{
		...
		$.getScript(temp,()=>{
			alert('nonmember UI: ');
			$container.html(compUI.nonmember());
	...
	var ticketingcancel =x=>{
		...
		$.getScript(temp,()=>{
			...
			$container.html(compUI.ticketingcancel());
	...
	var findbyid =x=>{
		...
		$.getScript(temp,()=>{
			alert('findbyid UI: ');
			$container.html(compUI.findbyid());
			$("#img_btn_id").click(e=>{
				alert('간편찾기 확인(ID)');
				joo.mega.idalert();
			});
	...
	var passalert =x=>{
		...
		$.getScript(temp,()=>{
			alert('passalert UI: ');
			$container.html(compUI.passalert());
	...
	var mymegabox =x=>{
		...
		$.getScript(temp,()=>{
			alert('mymegabox UI: ');
			$container.html(compUI.mymegabox());
			$("#col3").click(e=>{
				alert('예매확인/취소');
				joo.mega.ticketingcancel();
			});
	...
	var myinfoupdate =x=>{
		...
		$.getScript(temp,()=>{
			...
			$container.html(compUI.myinfoupdate());
	...
	var passchange =x=>{
		...
		$.getScript(temp,()=>{
			alert('passchange UI: ');
			$container.html(compUI.passchange());
	...
	var personalquit =x=>{
		...
		$.getScript(temp,()=>{
			...
			$container.html(compUI.personalquit());
...
var compUI={	
		...
		loginbox : ()=>{
			...
			+'<div class="header-wrap">'
				+'<div class="navigation">'
					+'<div class="logo" id="top_logo">'
						+'<a href="http://www.megabox.co.kr/" title="MEGABOX 메인으로 가기(140)"><img src="http://image2.megabox.co.kr//mop/home/logo_new.png" alt="MEGABOX" class="ie_logo big"></a>'
					+'</div>'
					+'<ul>'
//						+'<li><a href="javascript:showMenu('movie')" class="icon i1 " title="영화 바로가기">영화</a></li>'
//						+'<li><a href="javascript:showMenu('specialcontent')" class="icon i2 " title="큐레이션 바로가기">큐레이션</a></li>'
//						+'<li><a href="javascript:showMenu('theater')" class="icon i3 " title="영화관메인 바로가기">영화관메인</a></li>'
//						+'<li><a href="javascript:showMenu('special')" class="icon i4 " title="특별관 바로가기">특별관</a></li>'
//						+'<li><a href="javascript:showMenu('store')" class="icon i5 " title="스토어 바로가기"><span class="i_new">new</span>스토어</a></li>'
//						+'<li><a href="javascript:showMenu('event')" class="icon i6 " title="이벤트 바로가기">이벤트</a></li>'
//						+'<li class="login hide" id=""><a href="javascript:void(0)" class="icon i7" title="로그인">로그인</a></li>'						
						+'<li><a href="javascript:showMenu()" class="icon i1 " title="영화 바로가기">영화</a></li>'
						+'<li><a href="javascript:showMenu()" class="icon i2 " title="큐레이션 바로가기">큐레이션</a></li>'
						+'<li><a href="javascript:showMenu()" class="icon i3 " title="영화관메인 바로가기">영화관메인</a></li>'
						+'<li><a href="javascript:showMenu()" class="icon i4 " title="특별관 바로가기">특별관</a></li>'
...
//						+'<a href="javascript:void(0);" class="name_membership c_mint" onclick="showMenu('mypage-booking')" title="예매내역 바로가기">예매확인/취소</a>'
				...
				+'<!-- 드롭다운// --> '
				+'<div class="login_info remove_loginInfo open_myinfo_open" id="myinfo_wrap">'
					+'<div class="top">'
						+'<div class="title">'
...
//								+'<li><a href="javascript:void(0)" class="item3" onclick="showMenu('mypage-shopping')" title="스토어 구매내역 바로가기"><span class="blind">스토어구매내역</+span></'a></li>'
		...
		header : ()=>{
			...
			+'		<button type="button " class="btn_menu_all sub_c "><i class="fa fa-bars"></i>전체메뉴</button>'
